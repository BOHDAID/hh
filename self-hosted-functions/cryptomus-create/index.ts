 ...
 * cryptomus-create: إنشاء دفعة Cryptomus
 */
...
// Generate Cryptomus MD5 signature (hex). Note: WebCrypto doesn't support MD5 in Edge runtimes.
...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Prepare callback URL - use the same supabase URL
    ...
    console.log("Creating Cryptomus payment:", { order_id, amount, currency, callback: callbackUrl });
