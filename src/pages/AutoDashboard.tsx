...
import { Bot, Home, Key, Send, Shield, CheckCircle2, ExternalLink, Copy, Eye, EyeOff, Loader2, AlertCircle, BookOpen, LogIn, ChevronLeft, ChevronRight, User } from "lucide-react";
          ...
          <div className="bg-muted/50 rounded-xl p-6 border border-border space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                {telegramUser.username && (
                  <p className="text-sm text-muted-foreground" dir="ltr">@{telegramUser.username}</p>
                )}
                {telegramUser.phone && (
                  <p className="text-sm text-muted-foreground" dir="ltr">+{telegramUser.phone}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2 border-t border-border">
              <div className="bg-background rounded-lg p-3 border border-border">
                ...
                <p className="font-mono text-sm font-semibold text-foreground" dir="ltr">{telegramUser.id}</p>
              </div>
              <div className="bg-background rounded-lg p-3 border border-border">
      ...
      <main className="flex-1 p-6 md:p-10">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {mode === "login" ? "اتصل بحسابك على Telegram" : "اتبع الخطوات لإنشاء Session String"}
          </p>
        </div>
